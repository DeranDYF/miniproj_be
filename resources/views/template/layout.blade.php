...
<head>
    <base href="../">
    <title>MINI PROJECT - BACKEND | {{ $title }}
    </title>
    <meta charset="utf-8" />
    ...
    <meta property="og:title" content="Derandyfzn_ &amp; Laravel Admin Dashboard Theme" />
            ...
            <div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <a href="{{ route('dashboard') }}">
                        <img alt="Logo" src="assets/media/telu/logoTelU.png" class="h-30px logo" />
                    </a>
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="{{ route('dashboard') }}" class="d-lg-none">
                                <img alt="Logo" src="assets/media/telu/logoTelU.png" class="h-30px" />
                            </a>
                        </div>
